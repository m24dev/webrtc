import './RoomApp.css.proxy.js';
/* src\js\RoomApp.svelte generated by Svelte v3.29.6 */
import {
	SvelteComponent,
	attr,
	check_outros,
...
// (68:16) {#if connection.dataConnection && connection.mediaConnection}
...
// (67:12) {#each connections as connection}
...
class RoomApp extends SvelteComponent {
	constructor(options) {
		super();
